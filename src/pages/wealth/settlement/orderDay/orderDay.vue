<template>
    <div class="wrap">
        ...
        <a-card class="generalCard">
            <div class="searchBox" :style="{ maxHeight: !searchInfo.show ? 0 : '100%' }">
                <a-form auto-label-width layout="vertical" :model="searchInfo.data" ref="searchFormRef">
                    <a-row :gutter="16">>
                        ...
                        <a-col :xs="24" :sm="12" :md="8" :xl="6">
                            <a-form-item field="statement_month" :label="$t('orderDay.orderDay.5um7zpovnkg0')">
                                <!-- <a-range-picker v-model="searchInfo.data.statement_month" format="YYYY-MM-DD" /> -->
                                <a-date-picker v-model="searchInfo.data.statement_month" style="width: 100%;" />
                            </a-form-item>
                        </a-col>
                        <a-col :xs="24" :sm="12" :md="8" :xl="6">
                            <a-form-item field="real_name" :label="$t('orderDay.orderDay.5um7zpovnw80')">
                                <a-input v-model="searchInfo.data.real_name" :placeholder="$t('orderDay.orderDay.5um7zpovoq00')" />
                            </a-form-item>
                        </a-col>
            ...
            <div class="tableBox">
                <a-table :bordered="false" column-resizable :pagination="false" :loading="tableData.loading"
                    ...
                    <template #columns>
                        ...
                        <a-table-column :title="$t('orderDay.orderDay.5um7zpovkqo0')" data-index="asset_account_info.account" ></a-table-column>
                        <a-table-column :title="$t('orderDay.orderDay.5um7zpovuzk0')">
                        ...
                        <a-table-column :title="$t('orderDay.orderDay.5um7zpovv8o0')">
                            <template #cell="{ record }">
                        ...
                        <a-table-column
                            v-if="$permission(['wealthSettlementOrderDayDetails', 'wealthSettlementOrderDayDownload'])"
                            fixed="right" :title="$t('orderDay.orderDay.5um7zpovvf00')" :width="local.lang=='en'?160:120">
                            <template #cell="{ record }">
                                <a-space>
                                    <a-link v-permission="['wealthSettlementOrderDayDetails']"
                                        @click="toPath(record)">{{$t('orderDay.orderDay.5um7zpovvlc0')}}</a-link>
                                    <!-- <a :href="record.file_path" target="_bank" >下载</a> -->
                                    <a-link v-permission="['wealthSettlementOrderDayDownload']"
