            ...
            <div class="tableBox">
                <a-table :bordered="false" column-resizable :pagination="false" :loading="tableData.loading"
                    ...
                    <template #columns>
                        ...
                        <a-table-column
                            v-if="$permission(['OTCSettlementOrderDayDetails', 'OTCSettlementOrderDayDownload'])"
                            fixed="right" :title="$t('orderDay.orderDay.5um7zpovvf00')" :width="local.lang == 'en'?200:120">
                            <template #cell="{ record }">
                                <a-space>
                                    <a-link v-permission="['OTCSettlementOrderDayDetails']"
                                        @click="toPath(record)">{{$t('orderDay.orderDay.5um7zpovvlc0')}}</a-link>
                                    <!-- <a :href="record.file_path" target="_bank" >下载</a> -->
                                    <a-link v-permission="['OTCSettlementOrderDayDownload']"
